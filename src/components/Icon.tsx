...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  /* בעברית "חזרה" מצביע ימינה — לכיוון שממנו הגענו. */
  back: <path d="m10 6 6 6-6 6" />,
  hotel: (
    <>
      <path d="M3 20V6a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v14" />
      <path d="M16 10h3a2 2 0 0 1 2 2v8" />
      <path d="M2 20h20" />
  ...
  phone: (
    <path d="M15.5 21a13 13 0 0 1-12.5-12.5 2 2 0 0 1 2-2.1h2.6a1.4 1.4 0 0 1 1.4 1.2c.1.9.3 1.7.6 2.5a1.4 1.4 0 0 1-.3 1.5l-1 1a12 12 0 0 0 4.6 4.6l1-1a1.4 1.4 0 0 1 1.5-.3c.8.3 1.6.5 2.5.6a1.4 1.4 0 0 1 1.2 1.4v2.6a2 2 0 0 1-2.1 2z" />
  ),
  trips: (
